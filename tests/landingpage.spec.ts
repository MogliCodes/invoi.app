...
test.describe("Landing Page", () => {
  ...
  test("test", async ({ page }) => {
    ...
    await page.getByText("Kontakte").click();
    await page.getByRole("link", { name: "Kontakt erstellen" }).click();
    await page
      .locator("div")
      .filter({ hasText: /^First namePlease provide a first name$/ })
      .getByRole("textbox")
      .click();
    await page
      .locator("div")
    ...
    await page
      .locator("div")
      .filter({ hasText: /^Last namePlease provide a last name$/ })
      .getByRole("textbox")
      .fill("Lastname");
    await page
      .locator("div")
    ...
    await page
      .locator("div")
      .filter({ hasText: /^E-MailPlease provide a value$/ })
      .getByRole("textbox")
      .fill("email@test.de");
    await page
      .locator("div")
    ...
    await page
      .locator("div")
      .filter({ hasText: /^Date of birthPlease provide a value$/ })
      .getByRole("textbox")
      .fill("test");
    await page
      .locator("div")
    ...
    await page
      .getByPlaceholder("test", { exact: true })
      .press("ControlOrMeta+a");
    await page.getByPlaceholder("test", { exact: true }).fill("dob");
    await page
      .locator("div")
      .filter({ hasText: /^StreetPlease provide a value$/ })
      .getByRole("textbox")
      .fill("street");
    await page
      .locator("div")
      .filter({ hasText: /^ZIP CodePlease provide a value$/ })
      .getByRole("textbox")
      .fill("23");
    await page
      .locator("div")
      .filter({ hasText: /^CityPlease provide a value$/ })
      .getByRole("textbox")
      .fill("city");
    await page
      .locator("div")
