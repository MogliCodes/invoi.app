<template>
  <div class="flex flex-col sm:flex-row">
    ...
    <!--      </div>-->
    <!--    </div>-->
    <TheSidebar v-if="authStore.isUserLoggedIn" class="hidden md:block" />
    <main
      class="relative min-h-screen w-full bg-gray-100 py-24 md:ml-auto md:w-10/12 dark:bg-blue-100"
    >
      <StickyElement
